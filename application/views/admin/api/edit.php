            ...
            <div class="layui-tab layui-tab-card">
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        <form class="layui-form " action="/admin/api/edit" method="post">
                            ...
                            <div class="layui-form-item upload-content">
                                <label class="layui-form-label">
                                    ...
                                    <input type="file" accept="image/*" name="UploadFile" data-field="Image" data-savepath="gameImage" data-savename="" data-overwrite="true" onchange="upload(this)" style="display: none;">
                                </label>
