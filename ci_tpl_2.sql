...
CREATE DATABASE IF NOT EXISTS `ci_tpl` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `Config` (
  `Id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `Table` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '表名',
  `Name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '名称',
  `Columns` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '字段详情',
  `Infos` varchar(255) DEFAULT NULL COMMENT '说明',
  `Created` datetime DEFAULT NULL,
  `Updated` datetime DEFAULT NULL,
  PRIMARY KEY (`Id`) USING BTREE,
  KEY `Table` (`Table`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='快速配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Master` VALUES (1,'aa',1,'dev','$2y$10$jJB1KYL7SCqo6ZltT0Tmpe0GbuYP.w/ewj3BISrGvppKU9ofK7Dhq','35828E0C-3FDD-A73E-DC6E-521F730B0505',1,'2018-09-09 18:42:11','2018-09-16 20:46:30');
...
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='后台-菜单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-09-16 21:58:23
